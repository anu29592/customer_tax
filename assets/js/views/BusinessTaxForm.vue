                        ...
                        <b-card no-body class="mb-1">
                            <dt>
                                <b-card-header header-tag="header" class="p-1 header-1" role="tab">
                                    <b-btn block href="#" v-b-toggle.accordion1 variant="info" class="accordion-title accordionTitle js-accordionTrigger btn_header ">Vertragspartner (B)
                                        <div class="hint" >
                            ...
                            <dd>
                                <div class="container-fluid">
                                    <b-collapse id="accordion1" visible accordion="my-accordion" role="tabpanel">
                                        ...
                                        <b-card-body>
                                            <ContractualBusiness :formDataIdName="'contractualPartner'" v-bind:contractualPartner.sync="customerData.contractualPartner"> </ContractualBusiness>
                                        </b-card-body>
                                    </b-collapse>
                                </div>
                            </dd>
...
<script>
    import ContractualBusiness from '../components/ContractualBusiness.vue';
